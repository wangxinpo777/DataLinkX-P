...
export function deepseekApiCount ({ model, dateFrom, dateTo }) {
    return request({
        url: '/api/deepseek/dashboard/api/count',
        params: {
            model: model,
            dateFrom: dateFrom,
            dateTo: dateTo
...
export function deepseekTokenCount ({ model, dateFrom, dateTo }) {
    return request({
        url: '/api/deepseek/dashboard/token/count',
        params: {
            model: model,
            dateFrom: dateFrom,
            dateTo: dateTo
