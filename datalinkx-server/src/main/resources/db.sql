...
INSERT INTO `datalinkx`.`sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `route_name`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2012, 'DeepSeek', 1, 9999, '/DeepSeek', 'deepseek', NULL, 'deepseek', 0, 1, 'M', '0', '0', 'deepseek', 'deepSeek', '', NULL, '', NULL, '');
