package com.datalinkx.security.service.impl;

import com.datalinkx.common.constants.MetaConstants;
import com.datalinkx.common.constants.UserConstants;
import com.datalinkx.security.bean.domain.SysMenuBean;
import com.datalinkx.security.bean.domain.TreeSelect;
import com.datalinkx.security.bean.vo.MetaVo;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public String getRouterPath(SysMenuBean menu) {
        ...
        // 非外链并且是一级目录（类型为目录）
        if (menu.getParentId().equals("0") && UserConstants.TYPE_DIR.equals(menu.getMenuType()) && UserConstants.NO_FRAME.equals(menu.getIsFrame()) && !routerPath.equals("/")) {
    ...
    public boolean isMenuFrame(SysMenuBean menu) {
        return menu.getParentId().equals("0") && UserConstants.TYPE_MENU.equals(menu.getMenuType()) && menu.getIsFrame().equals(UserConstants.NO_FRAME);
    }
    ...
    public String innerLinkReplaceEach(String path) {
        return StringUtils.replaceEach(path, new String[]{MetaConstants.CommonConstant.HTTP, MetaConstants.CommonConstant.HTTPS, MetaConstants.CommonConstant.WWW, ".", ":"}, new String[]{"", "", "", "/", "/"});
    }
}
